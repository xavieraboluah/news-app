...
// apis 
const API_KEY = "778bf62c1e954aacb5d3ebf6c0d98899";
const HEADLINES_NEWS = "https://newsapi.org/v2/top-headlines?country=us&apiKey=";
const HOME_NEWS = "https://newsapi.org/v2/top-headlines?country=us&category=general&apiKey=";
...
contactBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Email: tnews@gmail.com</br>Contact: (+233)502090469</h4>";
    contactBtn;
});
...
const fetchHomeNews = async () => {
    const response = await fetch(HOME_NEWS+API_KEY);
    newsDataArr = [];
    if(response.status >=200 && response.status < 300) {
        const myJson = await response.json();
        newsDataArr = myJson.articles;
